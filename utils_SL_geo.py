...
def get_front_3d_line(x1x2, front_flags, cam_center, cam_frontaxis, if_debug=False):
    ...
    if not all(front_flags):
        if not front_flags[0] and not front_flags[1]:
            return None, None
        x_isect = isect_line_plane_v3(x1x2[0], x1x2[1], cam_center, cam_frontaxis, epsilon=1e-6)
